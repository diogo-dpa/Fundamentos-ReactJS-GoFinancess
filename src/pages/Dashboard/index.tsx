...
const Dashboard: React.FC = () => {
  const [transactions, setTransactions] = useState<Transaction[]>(() => {
		const storagedTransactions = localStorage.getItem('@GoFinances:transactions'); // pega o que está salvo no localStorage
  ...
  useEffect(() => {
    ...
    async function loadTransactions(): Promise<void> {
      ...
      // Melhora a questão de performance da aplicação
